...
import com.wjp.wcloudatlasbackend.manager.auth.annotation.SaSpaceCheckPermission;
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPage(@RequestBody PictureQueryRequest pictureQueryRequest, HttpServletRequest request) {
       ...
       ThrowUtils.throwIf(pageSize > 20, ErrorCode.PARAMS_ERROR);
        ...
        if(spaceId == null) {
            ...
            // TODO 应该有问题，这里创建团队空间的创建人无法 访问团队空间的图片
            boolean hasPermission = StpKit.SPACE.hasPermission(SpaceUserPermissionConstant.PICTURE_VIEW);
            ThrowUtils.throwIf(!hasPermission, ErrorCode.NO_AUTH_ERROR, "无权限访问");
//            已经改为 使用 注解鉴权
//            // 私有空间
...
//            }
    ...
    public BaseResponse<PictureTagCategory> pictureTagCategory(HttpServletRequest request) {
        ...
        List<String> tagList = Arrays.asList("热门", "搞笑", "生活", "艺术", "校园", "创意", "运动", "科技", "美食","旅行","时尚","其他");
        List<String> categoryList = Arrays.asList("模版", "电商", "表情包", "素材", "海报","插画","图标","字体","其他");
